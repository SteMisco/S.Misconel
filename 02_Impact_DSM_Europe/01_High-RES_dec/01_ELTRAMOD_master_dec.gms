...
*$set prevYear y2030
$set Run dsm100_dec100_200420



*Paths
$set data           data/MOD_input_dec
$set datatime       data/MOD_timeseries_%Year%_nonoptsysdec
$set dataNTC        data/NTC_dec
$set dataRES        data/RES_%Year%_dec100
$set dataP2X        data/P2X_dec
$set dataDSM        data/DSM_%Year%_dec
...
*===============================================================================
$ifthen.master set RunModel
$include 03_ELTRAMOD_invest_dispatch_dec.gms
$endif.master
