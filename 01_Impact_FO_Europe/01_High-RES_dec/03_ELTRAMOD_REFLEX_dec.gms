...
*===============================================================================
*              EQUATIONS for ELTRAMOD INVEST and DISPATCH
*===============================================================================
...
*annual electricity demand for p2h (heat pumps) to fulfill the district heat demand
dem_p2h(p2h)= sum((c,dev)$ (map_appC(p2h,c) and map_appDev(p2h,dev)),dem_p2x(c,'p2h','%year%')/ char_dev2(dev,'eta','%year%'))
;
