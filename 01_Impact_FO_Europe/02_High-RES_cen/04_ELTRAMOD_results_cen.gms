...
cap_p2p_exist(y,c,p2p)   capacity of existing fuel cells [MW] and h2-storages [MWh]
...
cap_p2p_new(c,p2p)       added + installed capacity of fuel cells (p2p-technology) [MW] and hydrogen-storage (p2p-technology) [MWh]
...
cap_p2p_exist(y,c,p2p) = char2_p2p(p2p,'inst_p2p');
...
cap_p2p_new(c,p2p)   = char2_p2p(p2p,'inst_p2p') + C_P2P.l(p2p);
...
execute_unload "%resultfile2%.gdx" cap_new, cap_add, C_ADD.l, eta_new, C_P2X.l, cap_p2x, cap_dsm_new, C_P2P.l, cap_p2p, cap_p2p_new;
